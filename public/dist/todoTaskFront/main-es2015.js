...
let LoginComponent = class LoginComponent {
    constructor(formBuilder, util, modal, httpService, route) {
...
let RegisterComponent = class RegisterComponent {
    constructor(formBuilder, modal, router, util, dataService, httpService) {
        this.formBuilder = formBuilder;
        this.modal = modal;
        this.router = router;
        this.util = util;
...
let CreateTaskComponent = class CreateTaskComponent {
    constructor(formBuilder, dataService, util, modal, httpService, route) {
        this.formBuilder = formBuilder;
        this.dataService = dataService;
        this.util = util;
        this.modal = modal;
...
let ViewTaskComponent = class ViewTaskComponent {
    constructor(httpService, modal, dataService, util, router) {
        this.httpService = httpService;
        this.modal = modal;
        this.dataService = dataService;
        this.util = util;
...
ViewTaskComponent.ctorParameters = () => [
